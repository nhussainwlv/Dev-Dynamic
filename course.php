...
<head>
    ...
    <title>WLV Courses | University Of Wolverhampton</title>
...
<body>
    ...
    <nav style="position: relative; overflow: hidden; width: 100%; box-sizing: border-box; padding-right: 20px;">
        <ul class="sidebar">
            ...
            <li><a href="course.html" style="color: red;">Courses</a></li>
        ...
        <ul>
            ...
            <li class="responsiveHeader"><a href="course.html" style="color: red;">Courses</a></li>
    ...
    <main>
        ...
        <!-- Courses Name And Description-->
        <h1>Courses Offered at the University of Wolverhampton</h1>
        ...
        <section class="courses-container">
            ...
            <div class="course">
                ...
                <div class="course-details">
                    ...
                    <div class="more-info">
                        <a href="https://www.wlv.ac.uk/courses/bsc-hons-cybersecurity/" target="_blank">More about Cybersecurity →</a>
                    </div>
                </div>
            </div>
            ...
            <div class="course">
                ...
                <div class="course-details">
                    ...
                    <div class="more-info">
                        <a href="https://www.wlv.ac.uk/courses/bsc-hons-computer-science/" target="_blank">More about Software Engineering →</a>
                    </div>
                </div>
            </div>
            ...
            <div class="course">
                ...
                <div class="course-details">
                    ...
                    <div class="more-info">
                        <a href="https://www.wlv.ac.uk/courses/msc-data-science/" target="_blank">More about Data Science →</a>
                    </div>
                </div>
            </div>
            ...
            <div class="course">
                ...
                <div class="course-details">
                    ...
                    <div class="more-info">
                        <a href="https://www.wlv.ac.uk/courses/bsc-hons-computer-science/" target="_blank">More about Computer Science →</a>
                    </div>
                </div>
            </div>
