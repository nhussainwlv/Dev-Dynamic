...
<head>
    ...
    <title>WLV Companion - Accommodation</title> <!-- Corrected duplicated title -->
...
<body>
    ...
    <main class="container">
        ...
        <section>
            ...
            <blockquote>You can apply for accommodation once you've officially registered for a course on the e:Vision system. After that, all you need is your student number.</blockquote>
        </section>
        ...
        <section>
            ...
            <blockquote>
                You can choose between ensuite or standard rooms in Telford, Walsall, and Wolverhampton for better access to our services.
                <a href="https://www.wlv.ac.uk/university-life/accommodation/where-can-i-live/">Click here to see more!</a>
            </blockquote>
        </section>
        ...
        <!-- Section: Ensuite Images -->
    <section>
        <h1>Ensuite Accommodation</h1>
        <div class="image-grid">
          <img src="https://www.wlv.ac.uk/media/departments/accommodation-services/images/Ensuite-Kitchen-2.jpg" alt="Ensuite kitchen">
          <img src="https://www.wlv.ac.uk/media/departments/accommodation-services/images/Ensuite-Room-2.jpg" alt="Ensuite bedroom">
          <img src="https://cdn-wlvacuk.terminalfour.net/media/departments/accommodation-services/images/accomm-pics-(5)-820x459.png" alt="Ensuite room view">
        </div>
      </section>

         <!-- Section: Standard Images -->
    <section>
        <h1>Standard Accommodation</h1>
        <div class="image-grid">
          <img src="https://www.wlv.ac.uk/media/departments/accommodation-services/images/Standard-Room-1-City.jpg" alt="Standard room">
          <img src="https://www.wlv.ac.uk/media/departments/accommodation-services/images/Kitchen-Basin.jpg" alt="Standard shared kitchen">
        </div>
      </section>
        ...
        <table>
          <thead>
            <tr>
              ...
              <th>2024/25 Weekly Cost</th>
              <th>42 Week Licence</th>
              <th>52 Week Licence</th>
              <th>Semester 1 (18 weeks)</th>
              <th>Semester 2 (24 weeks)</th>
            </tr>
          </thead>
          <tbody>
            <tr>
