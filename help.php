    ...
    <body>
        <nav style="position: relative; overflow: hidden; width: 100%; box-sizing: border-box; padding-right: 20px;">
            <ul class="sidebar">
                ...
                <li><a href="help.html" style="color: red;">Help</a></li>
            ...
            <ul>
                ...
                <li class="responsiveHeader"><a href="help.html" style="color: red;">Help</a></li>
        ...
        <!-- HELP AND FEEDBACK -->
        <h1>Require Help?</h1>
        <h2>Submit an inquiry here!</h2>

        <!-- Feedback Form -->
        <form action="includes/help_form.inc.php" method="POST">

        <label>Enter Information:</label>

            <!-- Full Name Input -->
            <input type="text" name="feedbackName" placeholder="Full Name:" required>

            <!-- Email Input -->
            <input type="email" name="feedbackEmail" placeholder="Email Address:" required>

            <!-- Select Issue from given options -->
            <label for="feedbackIssue">Select Issue(s):</label>
            <select name="feedbackIssue" required>
            <option value="Unlisted">Unlisted</option>
            <option value="Accomodation Help">Accomodation Help</option>
            ...
            <option value="Signup/Login Issue">Signup/Login Issue</option>
            </select>

            <!-- Enter Feedback Content -->
            <textarea name="feedbackContent" cols="40" rows="10" placeholder="Write your message:" required></textarea>
        ...
        <p>Or, feel free to contact us at:<br>
            Telephone: <a class="login-hyperlink" href="Tel:01902 321000">01902 321000</a><br>
            Email: <a class="login-hyperlink" href="Email:enquiries@wlv.ac.uk">enquiries@wlv.ac.uk</a><br>
            <br>
            By mail at:<br>
